...
parser.add_argument('--task', type=str, default='cifar10', help='(options) cifar10, cifar100')

args = parser.parse_args()

args.save = 'output/infer-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    if args.net_type == 'micro':
        ...
        net = EvoNetwork(genome, channels, num_classes, (32, 32), decoder='dense')
    else:
